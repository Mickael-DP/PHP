...
class form
{
	...
	public function __construct($action, $titre, $method="post")
	{
        ...
        $this->codeinit = "<fieldset><legend><span>$titre</span></legend>";
	...
	{
		$this->codetext.= "$libelle <input type='text' name='$name'/><br /><br />";  
	...
	{
		$this->codesubmit="<input type='submit' name='$name' value='$value'/><br /><br /></fieldset>" ;
	}
